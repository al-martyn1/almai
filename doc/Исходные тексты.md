...
- [Список исходных файлов проекта](#список-исходных-файлов-проекта)
  ...
  - [Все исходные тексты](#все-исходные-тексты)
    ...
    - [_libs](#_libs)
    - [_libs/marty_cdt](#_libsmarty_cdt)
    - [_libs/marty_cdt/impl](#_libsmarty_cdtimpl)
    - [_libs/marty_cdt](#_libsmarty_cdt-1)
    ...
    - [_libs/marty_lsp](#_libsmarty_lsp)
    - [_libs/marty_url](#_libsmarty_url)
    ...
    - [_libs/tmp_bak/results/umba](#_libstmp_bakresultsumba)
    - [_libs/tmp_bak/results/umba/internal](#_libstmp_bakresultsumbainternal)
    - [_libs/tmp_bak/results/umba](#_libstmp_bakresultsumba-1)
    - [_libs/tmp_bak/results/umba/types](#_libstmp_bakresultsumbatypes)
    - [_libs/tmp_bak/results/umba/warnings](#_libstmp_bakresultsumbawarnings)
    ...
    - [_src/cdt_tests](#_srccdt_tests)
    - [doc.scratch/docs3dp](#docscratchdocs3dp)
    - [prompts/05_what_to_do_reply](#prompts05_what_to_do_reply)
    - [tests](#tests)
    - [tests/almai-md-split-ai-result2](#testsalmai-md-split-ai-result2)
    - [tests/almai-md-split-ai-result3](#testsalmai-md-split-ai-result3)
    - [tests/almai-md-split-test01](#testsalmai-md-split-test01)
...
- `_test03.cpp` - Тестируем разбор "MdXml"
- `_test04.cpp` - Тестируем разбор frontmatter
- `_test05.cpp` - Тестируем чтение препромпта
- `_test06.cpp` - Тестируем сканирование препромптов (пока только в props и только в одном каталоге)
- `_test07.cpp` - Тестируем переименование файла
- `_test08.cpp` - Тестируем umba::command_line::CommandSequenceController
- `_test09.cpp` - Тестируем фичи almai, не захламляя проект almai
- `_test10.cpp` - Тесты запуска сторонних программ (без ожидания)
- `_test11.cpp` - Тест регистрации EXE без добавления в PATH
- `_test12.cpp` - Тест запуска chrome, и получения списка доступных страниц
- `_test13.cpp` - Тест запуска chrome, и получения списка доступных страниц - тестируем almai::ProjectDirs
- `_test14.cpp` - Тест запуска chrome, и получения списка доступных страниц - основная часть кода ушла в библиотеку
- `_test15.cpp` - Тест запуска chrome, отработка открытия страницы, события Page, Network, Runtime, DOM
- `_test16.cpp` - Тест запуска chrome, отработка открытия страницы, события Page, Network, Runtime, DOM - используем marty::cdt::Connection
- `_test17.cpp` - Тест запуска chrome, отработка открытия страницы, события Page, Network, Runtime, DOM - используем marty::cdt::Connection - специализированные функции
- `almai-cdt-eval.cpp` - Тест запуска chrome, отработка открытия страницы, события Page, Network, Runtime, DOM - используем marty::cdt::Connection - специализированные функции
- `almai-md-join.cpp` -
- `almai-md-split.cpp` -
- `almai.cpp` -
- `Маркер_языка.cpp` -
- `Хвостовой_маркер_языка.cpp` -
...
- `AtomicBoolIdHandler.h` - AtomicBoolIdHandler
- `AtomicBoolMethodHandler.h` - AtomicBoolMethodHandler
- `Connection.h` - Connection
- `Dom.h` - Dom
- `ErrorInfo.h` - ErrorInfo
- `JsonListResponse.h` - JsonListResponseEntry
- `JsonVersionResponse.h` - JsonVersionResponse
- `MessageIdVariant.h` - MessageIdVariant
- `PageNavigateResponse.h` - PageNavigateResponse
- `ResponseError.h` - ResponseError
- `WebSocketMessage.h` - WebSocketMessage - копия ix::WebSocketMessage, только поля все по значению
- `defs.h` - Types for marty_cdt

### _libs/marty_cdt/impl

- `Connection.h` - Connection

### _libs/marty_cdt

- `types.h` - Types for marty_cdt
- `utils.h` - Utils for marty_cdt
...
- `basics.h` - LSP IO utils
- `enums_generated.h` - Autogenerated enumerations (Umba Enum Gen)
- `lsp_enums.h` - LSP Enum types
- `lsp_io.h` - LSP IO utils
- `lsp_types.h` - LSP data types (LSP 3.17)
- `lsp_utils.h` - LSP utilities: URI/path conversion, workspace helpers
- `marty_lsp.h` - Main header
- `protocol_header.h` - LSP IO utils
- `protocol_request.h` - LSP IO utils
- `utils.h` - LSP IO utils

### _libs/marty_url

- `percent_encoding.h` - URL percent encoding/decoding

### _libs/marty_yaml_toml_json

- `declare_marty_json.h` - Declaration of marty::json
- `fsss.h` -
- `json_utils.h` -
- `marty_yaml_toml_json.h` - Main file to include
...
- `simple_formatter.cpp` - Реализация SimpleFormatter
...
### _libs/tmp_bak/results/umba/types
...
- `attribute_weak.h` -
- `autolock.h` - Автоматический захват и освобождение ресурса. Объект-ресурс должен предоставлять методы lock и unlock.
- `basic_enums.h` - Хелперы для enum'ов
- `basic_interfaces.h` - Базовые интерфейсы
- `basic_interfaces_impl.h` - Реализация некоторых базовых интерфейсов
- `bits.h` - Манипуляции с битами
- `bits_fmt.h` - Вывод битсетов в поток
...
- `filesys_scanners.h` - Cканеры по файловой системе.
...
- `disable_condition_is_const.h` -
- `disable_def_ctor_implicitly_deleted.h` -
- `disable_deprecated_declarations.h` -
- `disable_enumerator_not_handled.h` -
- `disable_fn_or_var_unsafe.h` -
- `disable_grpc_warnings.h` -
- `disable_implicit_copy_ctor_deprecated.h` -
- `disable_non_portable_variadic.h` -
- `disable_non_trivial_destructor_not_virtual.h` -
- `disable_padding_added.h` -
- `disable_protobuf_warnings.h` -
- `disable_rel_inc_contains_dbldot.h` -
- `disable_result_not_used.h` -
- `disable_signed_unsigned_mismatch.h` -
- `disable_spectre_mitigation.h` -
...
- `push_disable_C4355.h` -
- `push_disable_C4365.h` -
- `push_disable_C4371.h` -
- `push_disable_C4464.h` -
- `push_disable_C4555.h` -
- `push_disable_C4623.h` -
- `push_disable_C4625.h` -
- `push_disable_C4668.h` -
- `push_disable_C4800.h` -
- `push_disable_C4820.h` -
- `push_disable_C4840.h` -
- `push_disable_C4868.h` -
- `push_disable_C4946.h` -
- `push_disable_C4996.h` -
- `push_disable_C5026.h` -
- `push_disable_C5045.h` -
- `push_disable_C5204.h` -
- `push_disable_C5219.h` -
- `push_disable_C5243.h` -
- `push_disable_C5267.h` -
- `push_disable_common.h` -
- `push_disable_condition_is_const.h` -
- `push_disable_def_ctor_implicitly_deleted.h` -
- `push_disable_deprecated_declarations.h` -
- `push_disable_enumerator_not_handled.h` -
- `push_disable_fn_or_var_unsafe.h` -
- `push_disable_grpc_warnings.h` -
- `push_disable_implicit_copy_ctor_deprecated.h` -
- `push_disable_non_portable_variadic.h` -
- `push_disable_non_trivial_destructor_not_virtual.h` -
- `push_disable_padding_added.h` -
- `push_disable_protobuf_warnings.h` -
- `push_disable_rel_inc_contains_dbldot.h` -
- `push_disable_result_not_used.h` -
- `push_disable_signed_unsigned_mismatch.h` -
- `push_disable_spectre_mitigation.h` -
...
- `push_disable_trivial_destructor_not_virtual.h` -
- `push_disable_unsafe_conversion.h` -
- `push_disable_unused_parameter.h` -
...
- `AppConfig.cpp` - Конфиг главного приложения - реализация
- `AppConfig.h` - Конфиг главного приложения
- `AppConfigBase.h` - Базовый конфиг
- `AppVerConfig.h` -
- `ArgParser.h` -
- `CdtEvalAppConfig.h` -
- `CdtEvalAppVerConfig.h` -
- `CdtEvalArgParser.h` -
- `Descriptions.h` - Types which hold descriptions
...
- `Preprompt.h` - Types which hold descriptions
- `PrepromptDatabase.h` - Types which hold descriptions
- `Project.h` - Almai проект
- `ProjectDirs.h` - Информация по проекту - каталоги, порты, кеши
- `Test08ArgParser.h` -
- `_test01.cpp` - Тесты утилитарных функций
- `_test02.cpp` - Тест задания путей поиска
- `_test03.cpp` - Тестируем разбор "MdXml"
...
- `clipboard.h` -
- `context-id.h` -
- `description_filename.h` -
- `dict.h` -
- `dir-tree-sort.h` -
- `empty_option_error.h` -
- `empty_option_seal.h` -
- `expression.h` -
- `fence_style.h` -
- `file-list.h` -
...
- `enums.h` - Autogenerated enumerations (Umba Enum Gen)
- `log.h` -
- `md_utils.h` - Утилитарные функции проекта
- `result.h` - ResultCode testing macros
- `utils.h` - Утилитарные функции проекта
- `yaml_json.h` - Утилитарные функции для YAML/JSON
...
- `Prompt_Engineering_The_Art_of_Instructing_AI.mhtml` -

### prompts/05_what_to_do_reply
...
### tests/almai-md-split-ai-result2

- `pyproject.toml` -

### tests/almai-md-split-ai-result3

- `pyproject.toml` -

### tests/almai-md-split-test01
