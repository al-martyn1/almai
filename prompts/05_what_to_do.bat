...
@set TESTS_OUTPUT="%PROMPTS_DIR%\_test17.txt"
@rem "%PROMPTS_DIR%\_test16_03.txt" "%PROMPTS_DIR%\_test16_03_DOM.txt" "%PROMPTS_DIR%\_test17.txt"
...
@set PROMPTS_MDS=%PROMPTS_MD_04% %PROMPTS_MD_05% %PROMPTS_MD_06%
@rem %PROMPTS_MD_01% 
@rem %PROMPTS_MD_04% 
@rem %PROMPTS_MD_05% %PROMPTS_MD_06%

almai-md-join %CMN_OPTS% "-o=%~dp0\%~n0.md" --attach-format=md "--hefooter=%~dp0\%~n0.txt" %CDT_SRC% %TESTS_SRCS% %TESTS_OUTPUT% %PROMPTS_MDS%
