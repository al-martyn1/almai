...
- Тест `_test17.cpp` и его вывод - `_test17.txt`


Мне нужно научится управлять браузером - находить конкретные элементы управления (они могут быть созданы динамически скриптами,
значит, нужно уметь отслеживать какие-то события страницы и/или сети), двигать мышкой, имитировать другие действия мышкой,
активировать контролы, имитировать ввод с клавиатуры. Но не стоит на этом акцентироваться.

Также я хочу уметь собирать данные для последующего анализа при помощи искуственного интеллекта - вот это важно.
...
Теперь нужно расписать всё очень подробно и детально, с упором на то, что и как мне необходимо реализовать.
